...
import { MessageSquare, Mail, Send, Reply, Archive, Search } from "lucide-react";
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      from: "Ana García",
      email: "ana@email.com",
      subject: "Consulta sobre tour de aventura",
      content: "Hola, estoy interesada en el tour de aventura para 4 personas el próximo fin de semana. ¿Tienen disponibilidad?",
    ...
    },
    {
      ...
      content: "Buenos días, necesito confirmar mi reserva para el tour del sábado. Ya realicé el pago.",
    ...
    },
    {
      ...
      content: "Quiero expresar mi inconformidad con el tour de ayer. El guía llegó tarde y no cumplió con lo prometido.",
    ...
    },
    {
      ...
      subject: "Información sobre tarifas grupales",
      content: "Buenas tardes, quisiera información sobre tarifas para grupos de más de 10 personas.",
