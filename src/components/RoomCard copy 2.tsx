...
export const RoomCard = ({ room, hotel }: RoomCardProps) => {
  ...
  const handleReserve = (room: Room, hotel:Business) => {
    navigate(`/hotel/${hotelId}/reservation/${room.id}, { state: { room, hotel }`); 
  };
            ...
            <CardContent className="p-6 flex-grow flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between mt-4 border-t pt-4">
                ...
                <Button 
                  ...
                  className="bg-sabana border-turismo hover:bg-turismo hover:border-sabana"
                >
                  Reservar ahora
                </Button>
              </div>
