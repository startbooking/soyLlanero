    ...
    <div className="space-y-1">
      ...
      {searchResults.length === 0 && !isSearching && (
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-foreground text-center py-8">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <Button 
                      className="border border-black-500 bg-sabana hover:bg-sabana/50 text-black-500" variant="outline" size="sm"
                      onClick={handleViewDetails}
                      >Ver Detalles</Button>
